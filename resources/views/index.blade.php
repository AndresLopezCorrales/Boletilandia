...
<head>
    ...
    <title>Boletilandia</title>
    @include('head') {{-- Imagen de tab de pestaña --}}
    @vite(['resources/css/app.css', '/resources/css/galeria-style.css'])
</head>
    <body>
        {{-- Si esta logeado a la página, lo mandará al home de su respectivo tipo de usuario (user/admin) --}}
        @if (Route::has('login'))           
            @auth
        ...
        {{--Si aún no se está loggeado, te mandará a la página para que hagas log in o sign in --}}
        @else
        ...
        <div class="flex min-h-screen justify-center items-center">
            ...
            {{--DIV donde está titulo de la página y botones de log in y sign in--}}
